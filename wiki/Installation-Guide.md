...
Latest stable release: **[ClipPAilot v1.0.6](https://github.com/ronled86/ClipPAilot/releases/latest)**
...
```cmd
ClipPAilot-Setup-1.0.6.exe /D=C:\CustomPath\ClipPAilot
```
